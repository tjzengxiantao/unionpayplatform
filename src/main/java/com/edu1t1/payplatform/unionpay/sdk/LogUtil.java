...
public class LogUtil {
	...
	private final static Logger GATELOG = LogManager.getLogger("UNIONPAY_SDK_LOG");
	private final static Logger GATELOG_ERROR = LogManager.getLogger("UNIONPAY_SDK_ERR_LOG");
	private final static Logger GATELOG_MESSAGE = LogManager.getLogger("UNIONPAY_SDK_MSG_LOG");
